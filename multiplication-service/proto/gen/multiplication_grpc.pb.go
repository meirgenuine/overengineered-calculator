...
const (
	MultiplicationService_Multiply_FullMethodName = "/multiplication.MultiplicationService/Multiply"
)
...
func (c *multiplicationServiceClient) Multiply(ctx context.Context, in *MultiplicationRequest, opts ...grpc.CallOption) (*MultiplicationResponse, error) {
...
func (UnimplementedMultiplicationServiceServer) Multiply(context.Context, *MultiplicationRequest) (*MultiplicationResponse, error) {
...
func _MultiplicationService_Multiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MultiplicationServiceServer).Multiply(ctx, req.(*MultiplicationRequest))
	}
